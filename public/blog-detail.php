...
if (!$slug) {
    die("Blog slug is required.");
}

// Step 1: Fetch the blog with category and author
$stmt = $pdo->prepare("
    SELECT b.*, 
...
function fixImagePaths($content) {
    return preg_replace_callback('/<img[^>]+src=["\'](?!https?:\/\/|\/|\.\/admin\/)([^"\']+)["\']/i', function ($matches) {
        $fixedSrc = './admin/' . $matches[1];
        return str_replace($matches[1], $fixedSrc, $matches[0]);
    }, $content);
}
...
<head>
    ...
    <meta name="description" content="<?= htmlspecialchars($blog['meta_description'] ?? substr(strip_tags($blog['content']), 0, 160)) ?>">
    ...
    <meta property="og:image" content="./admin/<?= ($blog['picture']) ?>">
...
<body>
    ...
    <div class="maininnercontents iffooter" style=" background: url('./images/Blog_page-BG.webp') no-repeat center;">
            ...
            <div class="content">
                ...
                <div class="detaillinner"> 
                    ...
                    <div class="blogdetail">
                        <img src="./admin/<?= $blog['picture']?>" alt=" <?= htmlspecialchars($blog['title']) ?>">
